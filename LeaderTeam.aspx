<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaderTeam.aspx.cs" Inherits="LeaderTeam" %>
            ...
            <section class="title-section">
                <div class="container">
                    ...
                    <div class="row crumbs">
                        <div class="col-md-12">
                            <a href="index-2.html">Home</a> / Leadership Team
                    ...
                    <div class="row title">
                        ...
                        <div class="col-md-9">
                            <h1>Our Team
                                ...
                                <span class="subtitle-section">our pillars
                        ...
                        <div class="col-md-4 desing">
                            <div class="item-work">
                                <div class="hover">
                                    ...
                                    <a href="img/works/1.jpg" class="fancybox" title="Zoom Image">
                                        <div class="overlay"></div>
                                    </a>
                                </div>
                                <div class="info-work">
                                    <h4>Yaksh Kumar Singh</h4>
                                    <p>CEO</p>
                        ...
                        <div class="col-md-4 development">
                            <div class="item-work">
                                <div class="hover">
                                    ...
                                    <a href="img/works/2.jpg" class="fancybox" title="Zoom Image">
                                        <div class="overlay"></div>
                                    </a>
                                </div>
                                <div class="info-work">
                        ...
                        <div class="col-md-4 development">
                            <div class="item-work">
                                <div class="hover">
                                    ...
                                    <a href="img/works/3.jpg" class="fancybox" title="Zoom Image">
                                        <div class="overlay"></div>
                                    </a>
                                </div>
                                <div class="info-work">
                                    <h4>Vivek Kumar Singh</h4>
                                    <p>Adviser</p>
                                    <div class="icons-work">
                                        <i class="fa fa-facebook" data-toggle="tooltip" title data-original-title="facebook"></i>
                                        <i class="fa fa-twitter" data-toggle="tooltip" title data-original-title="twitter"></i>
